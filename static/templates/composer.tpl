            ...
            <form id="optional-form">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input value="{optionalData.discountPrice}" type="text" class="form-control" id="discount-money-input" placeholder="[[thesiscomposer:discount-money-placeholder]]">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="expired-date-input">[[thesiscomposer:expired-time]]</label>
                        <input value="{optionalData.expiredTime}" type="text" class="form-control" id="expired-time-input" placeholder="[[thesiscomposer:expired-time-placeholder]]">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
